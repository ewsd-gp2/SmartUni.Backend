...
namespace SmartUni.PublicApi.Features.Staff.Queries
{
    ...
    {
        private record Response(Guid Id, string Name, string Email, string PhoneNumber, string Gender,string UserCode);
        ...
        public sealed class Endpoint : IEndpoint
        {
                ...
                CancellationToken cancellationToken)
            {
                ...
                IEnumerable<Response> staff = await dbContext.Staff
                    ...
                    .Where(x => !x.IsDeleted)
                    .Select(t => new Response(t.Id, t.Name, t.Identity.Email, t.Identity.PhoneNumber, t.Gender.ToString(),t.UserCode))
