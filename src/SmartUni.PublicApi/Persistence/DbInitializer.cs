...
public static class DbInitializer
{
        ...
        RoleManager<IdentityRole<Guid>> roleManager)
    {
        ...
        {
            Staff? hadgrid = await context.Staff.FirstOrDefaultAsync(s => s.IdentityId == hadgridUserId);
            ...
            Tutor[] tutors = new[]
            {
                new Tutor
                {
                    ...
                    Gender = Enums.GenderType.Male,
                    Major = Enums.MajorType.Computing,
                    CreatedBy = hadgrid?.IdentityId ?? Guid.Empty,
                    CreatedOn = new DateTime(new DateOnly(2025, 3, 16), new TimeOnly(19, 0, 0, 0),
                        DateTimeKind.Utc),
                    IdentityId = snapeUserId
                }
            };
            await context.Tutor.AddRangeAsync(tutors);
            await context.SaveChangesAsync();
        }
